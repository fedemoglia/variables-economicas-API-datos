...
Ejemplo de uso de la función para obtener la cotización del dólar. (Dolar.gs)
En una celda escriben la fórmula =valueDolar(A7) donde A7 es una celda con una fecha o =valueDolar("2018-09-02"), previamente hay que crear un script con un archivo con el código en https://script.google.com/home. Cuando empiecen a escribir la función en la hoja de cálculo les va a aparecer la opción para autocompletarla.
